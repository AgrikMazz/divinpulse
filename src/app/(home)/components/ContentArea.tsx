    ...
    return (
        <div>
            <div className="flex flex-col rounded-md items-center justify-between bg-white">
                ...
                <div className="relative flex flex-col justify-center text-center h-fit w-full mb-10">
                    <img className="absolute inset-0 object-cover h-full w-full overflow-hidden" src={LightPoster.src} alt="banner" />
                        ...
                        <div className="relative container mx-auto grid grid-cols-1 md:grid-rows-2 md:grid-cols-2 gap-x-56 gap-y-10 w-full h-full m-14 overflow-hidden">
